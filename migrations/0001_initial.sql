...
CREATE TABLE IF NOT EXISTS equipment (
  ...
  created_at TEXT NOT NULL,
  updated_at TEXT NOT NULL,
  FOREIGN KEY (station_id) REFERENCES station_profiles(id) ON DELETE SET NULL
);
...
CREATE INDEX IF NOT EXISTS idx_qsos_my_callsign ON qsos(my_callsign, qso_datetime_utc DESC);
CREATE INDEX IF NOT EXISTS idx_qsos_their_callsign ON qsos(their_callsign, qso_datetime_utc DESC);
...
CREATE TABLE IF NOT EXISTS qsl_cards (
  ...
  card_type TEXT NOT NULL DEFAULT 'paper',
  image_path TEXT,
  event_date TEXT,
  notes TEXT,
  created_at TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_qsl_cards_qso ON qsl_cards(qso_id);
